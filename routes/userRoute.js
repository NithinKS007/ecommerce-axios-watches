...
userRoute.post("/verifyOtp",noCacheMid.noCacheMiddleware,userAuth.isUserLogout,userAuthController.verifyOtp)
userRoute.get("/resendOtp",noCacheMid.noCacheMiddleware,userAuth.isUserLogout,userAuthController.resendOtp)
...
userRoute.get("/forgotPassword",noCacheMid.noCacheMiddleware,userAuth.isUserLogout,userAuthController.loadForgotPassword)
userRoute.patch("/forgotPassword",noCacheMid.noCacheMiddleware,userAuth.isUserLogout,userAuthController.handleForgotPassword)
userRoute.get("/resetPassword",noCacheMid.noCacheMiddleware,userAuth.isUserLogout,userAuthController.loadResetPassword)
userRoute.patch("/resetPassword",noCacheMid.noCacheMiddleware,userAuth.isUserLogout,userAuthController.ResetPassword)

// Product details and cart routes
userRoute.get("/productDetails", noCacheMid.noCacheMiddleware,homePageController.loadProductDetails)
userRoute.post("/productDetails",isBlocked, noCacheMid.noCacheMiddleware,userAuth.isUserLogin,cartController.addToCart)
...
userRoute.post("/cart/applyCoupon",isBlocked, noCacheMid.noCacheMiddleware,userAuth.isUserLogin,couponController.applyCoupon)
userRoute.delete("/cart/removeCoupon",isBlocked, noCacheMid.noCacheMiddleware,userAuth.isUserLogin,couponController.removeCoupon)

// Checkout and Payment routes
userRoute.get("/checkout",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,userOrderController.loadCheckout)
userRoute.post("/checkout/addAddress",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,addressController.addAddress)
userRoute.post("/checkout",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,userOrderController.placeOrder)

userRoute.post("/verifyOnlinePayment",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,checkoutOnlinePaymentController.verifyOnlinePayment)
userRoute.get("/paymentFailure",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,checkoutOnlinePaymentController.loadPaymentFailure)
userRoute.patch("/paymentFailure",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,checkoutOnlinePaymentController.handleOnlinePaymentFailure)
...
userRoute.get("/placeOrder",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,userOrderController.loadPlaceOrder)
userRoute.get("/orders",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,userOrderController.loadOrders)
...
userRoute.get("/orderDetails",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,userOrderController.loadOrderDetails)
userRoute.patch("/return",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,userOrderController.returnProductOrder)
...
userRoute.delete("/address",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,addressController.removeAddress)
userRoute.get("/addAddress",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,addressController.loadAddAddress)
userRoute.post("/addAddress",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,addressController.addAddress)
userRoute.put("/editAddress",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,addressController.editAddress)

// Wishlist routes
userRoute.get("/wishList",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,wishListController.loadWishList)
userRoute.post("/wishList",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,wishListController.addToWishList)
userRoute.delete("/wishList",isBlocked,noCacheMid.noCacheMiddleware,userAuth.isUserLogin,wishListController.removeFromWishList)
