...
adminRoute.get(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  userController.loadCustomer
);
adminRoute.patch(
  "/customerlist",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  userController.blockOrUnblockCustomer
);
...
adminRoute.get(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  categoryBrandController.loadCategoryBrand
);
adminRoute.patch(
  "/brandCategoryManagement",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  softdeleteHandle.handleSoftDelete
);
adminRoute.put(
  "/brandCategoryManagement",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  handleEditCategoryBrand.handleEditCategoryBrand
);
adminRoute.post(
  "/brandCategoryManagement",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  categoryBrandController.addCategoryBrand
);
adminRoute.get(
  "/brandCategoryExists",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  handleCategoryBrandExists.handleCategoryBrandExists
);
...
adminRoute.post(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  imageUpload.upload.array("productimages", 4),
...
adminRoute.get(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  adminOrderController.loadOrderList
);
adminRoute.get(
  "/orderDetailsPage",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  adminOrderController.loadOrderDetailsPage
);
adminRoute.post(
  "/orderDetailsPage",
  noCacheMid.noCacheMiddleware,
...
adminRoute.patch(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  couponController.activateDeactivateCoupon
);
...
adminRoute.get(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  adminOrderController.loadReturnedOrder
);
adminRoute.patch(
  "/updateReturnStatus",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  handleReturnStatus.handleReturnStatus
);
...
adminRoute.get(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  dashboardController.fetchSalesReport
);
adminRoute.get(
  "/bestSellers",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  bestSellersController.bestSellers
);
...
adminRoute.get(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  offerController.loadCategoryOffer
);
adminRoute.get(
  "/addCategoryOffer",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  offerController.loadAddCategoryOffer
);
adminRoute.post(
  "/addCategoryOffer",
  noCacheMid.noCacheMiddleware,
...
adminRoute.patch(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  offerController.activateDeactivateCategoryOffer
);
adminRoute.get(
  "/editCategoryOffer",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  offerController.loadEditCategoryOffer
);
adminRoute.put(
  "/editCategoryOffer",
  noCacheMid.noCacheMiddleware,
...
adminRoute.get(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  offerController.loadProductOffer
);
adminRoute.get(
  "/addProductOffer",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  offerController.loadAddProductOffer
);
adminRoute.post(
  "/addProductOffer",
  noCacheMid.noCacheMiddleware,
...
adminRoute.patch(
  ...
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  offerController.activateDeactivateProductOffer
);
adminRoute.get(
  "/editProductOffer",
  noCacheMid.noCacheMiddleware,
  adminAuth.isAdminLogin,
  offerController.loadEditProductOffer
);
adminRoute.put(
  "/editProductOffer",
  noCacheMid.noCacheMiddleware,
