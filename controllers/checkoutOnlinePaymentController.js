...
const verifyOnlinePayment = async (req, res) => {
  try {
    ...
    console.log(
      `error while verifiying the online payment for razorpay`,
      error.message
    );
...
const handleOnlinePaymentFailure = async (req, res) => {
  try {
    ...
    console.log(
      `error while checking the onlinepayment failure`,
      error.message
    );
...
const loadRetryOrderCheckout = async (req, res) => {
  try {
    ...
    console.log(
      `error while loading the checkout page for retrying order`,
      error.message
    );
